                ...
                <Container>  
                  <Row className="justify-content-center">  
                      ...
                      <Card className="mx-4">  
                        <CardBody className="p-4">  
                          <Form onSubmit={UpdateCustomer}>  
                            <h3 align="center">Update Request</h3>  <br/>
                            ...
                            {/* <InputGroup className="mb-4">  
                              <Input type="date"  name="DateOfBirth"  value={customer.DateOfBirth} onChange={ onChange } placeholder="Date Of Birth" />  
                            </InputGroup> */}
                    ...
                    <input name="Gender" id="Female" placeholder="Gender" value="Female" onChange={onChange} type="radio"/>Female &nbsp;&nbsp;
                            ...
                            {/* <InputGroup className="mb-4">  
                              <Input type="text"  name="Pin"  value={customer.Pin} onChange={ onChange } placeholder="Pin" />  
                            </InputGroup> */}
                            <InputGroup className="mb-4">  
                              <Input type="text"  name="OpeningBal"  value={customer.OpeningBal} onChange={ onChange } placeholder="OpeningBal" disabled/>  
                            </InputGroup>
                            <InputGroup className="mb-4">  
                              <Input type="text"  name="AadharNum"  value={customer.AadharNum} onChange={ onChange } placeholder="AadharNum" disabled/>  
                            </InputGroup>
